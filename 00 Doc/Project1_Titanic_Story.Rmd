...
2. Run the Visualizations in the 02 Visualizaiton file  
...
```
This new plot examines the relationship between Fare charged and what gender the passenger was. At the same time, this plot also looks at the relationship between Fare and passenger class. This plot confirms the idea that on average, the lower your class, the lower the fare you pay. 
Here is the R code used to produce this plot:
```
require(extrafont)
ggplot() + 
